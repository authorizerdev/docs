...
Please ask as many questions as you need, either directly in the issue or on [Discord](https://discord.gg/Zv2D5h6kkK). We're happy to help.
...
3. `cd authorizer`
4. Build the code `make clean && make`
...
5. Run binary with required flags:
   ...
   ```
   Check all the supported flags [here](/core/server-config)
