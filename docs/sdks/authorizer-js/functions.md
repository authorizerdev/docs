...
> Note: You will need a SMTP server with an email address and password configured as [authorizer environment](/docs/core/server-config/) using which system can send emails.
