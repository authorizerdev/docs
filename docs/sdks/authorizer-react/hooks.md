...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `config`        | Root configuration object passed to `AuthorizerProvider` + backend configuration obtained via [`meta`](/docs/sdks/authorizer-js/functions#--getmetadata) api                                               |
| `user`          | If not logged in this is `null`, else it includes all the user related information like `email`, `given_name`, `family_name`, `picture`, and [more](/docs/sdks/authorizer-js/functions#--getprofile)       |
...
| `authorizerRef` | Reference to [authorizer-js](/docs/sdks/authorizer-js) instance which can be used to call [functions](/docs/sdks/authorizer-js/functions) exposed by [authorizer-js](/docs/sdks/authorizer-js) |
