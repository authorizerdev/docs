...
| `authorizerRef` | Reference to [authorizer-js](../authorizer-js/) instance which can be used to call [functions](../authorizer-js/functions) exposed by [authorizer-js](../authorizer-js/) |
