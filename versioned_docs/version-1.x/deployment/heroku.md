...
Deploy Authorizer with postgres DB using [heroku](https://github.com/authorizerdev/authorizer-heroku) and play with it in 30seconds
...
The Authorizer app with Heroku `buildpack/configuration` is available at: [Github](https://github.com/authorizerdev/authorizer-heroku).
...
Let's say your Heroku app is called authorizer-heroku and is running on [heroku](https://authorizer-heroku.herokuapp.com).
